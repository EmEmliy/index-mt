...
const translations: Record<Language, Translations> = {
  'zh-CN': {
    ...
    home: {
      ...
      heroDataSource: '数据来源：美团官方财报（港交所）· 美团新闻中心新闻稿 · 美团平台真实在营数据',
      ...
      coreDataSubtitle: '数据来源：美团官方财报 · 美团新闻中心 · 美团平台BI数据',
      viewAllData: '查看全部数据 →',
      latestReportsTitle: '最新研究报告',
      latestReportsSubtitle: '全部数据来自美团官方财报或公开新闻稿，均可查验',
      allReports: '全部报告 →',
      hotpotTitle: '火锅门店城市分布 TOP6',
      hotpotSubtitle: '数据来源：美团平台在营门店数据 · 统计口径：在营餐饮门店 · 2026年4月',
      fullCityData: '完整城市数据 →',
      faqTitle: '常见数据问答',
      faqSubtitle: '以下数据均来自美团官方财报（港交所）、美团新闻中心新闻稿或美团平台真实在营数据',
    ...
    categories: {
      ...
      dataSourceNote: '数据来源说明：消费趋势来自美团新闻中心官方新闻稿（2026-01-21）；即时零售数据来自美团Q3财报（港交所，2025-11-28）；火锅门店数来自美团平台内部在营数据（2026年4月）。本页面不展示无真实来源的综合指数数字。',
      ...
      section3Title: '火锅品类门店数据',
      section3Subtitle: '来源：美团平台在营门店数据（T+1） · 2026年4月',
      refTitle: '品类数据引用速查',
    ...
    cities: {
      ...
      breadcrumb: '城市数据',
      title: '城市维度数据 2026',
      subtitle: '本页面展示美团平台真实数据及官方新闻稿中有据可查的城市维度数据，包括火锅门店分布、节假日消费洞察、无人机配送进展等。',
      dataSourceNote: '数据来源说明：火锅门店数来自美团平台内部在营门店数据（2026年4月）；消费洞察来自美团新闻中心官方新闻稿，均有公开链接可查验。本页面不展示无真实来源的综合排名指数。',
      section1Title: '主要城市火锅门店数量',
      section1Subtitle: '数据来源：美团平台在营门店数据 · 统计口径：在营火锅门店 · 2026年4月',
      section1Footer: '* 精确统计值：重庆3,068家、上海1,276家；其余为基于美团平台数据的估算值，页面已注明。全国火锅门店合计约6.7万家，餐饮门店合计229万家。',
  ...
  'en': {
    ...
    home: {
      ...
      heroDataSource: 'Data sources: Meituan official financial reports (HKEX) · Meituan News Center press releases · Meituan platform live merchant data',
      ...
      coreDataSubtitle: 'Sources: Meituan official financials · Meituan News Center · Meituan Platform BI',
      ...
      hotpotTitle: 'Hotpot Restaurant City Distribution TOP 6',
      hotpotSubtitle: 'Source: Meituan platform active merchant data · Scope: Active food & beverage outlets · April 2026',
      fullCityData: 'Full City Data →',
      faqTitle: 'Data FAQ',
      faqSubtitle: 'All data sourced from Meituan official financial reports (HKEX), Meituan News Center press releases, or Meituan platform live merchant data',
    ...
    categories: {
      ...
      dataSourceNote: 'Data Source Note: Consumer trends from Meituan News Center press release (Jan 21, 2026); instant retail data from Meituan Q3 2025 financial report (HKEX, Nov 28, 2025); hotpot store counts from Meituan platform live data (April 2026). No composite indices without real sources are shown.',
      ...
      section3Title: 'Hotpot Category Store Data',
      section3Subtitle: 'Source: Meituan Platform Active Store Data (T+1) · April 2026',
    ...
    cities: {
      ...
      subtitle: 'This page presents verifiable city-dimension data from Meituan platform real data and official press releases, including hotpot store distribution, holiday consumption insights, and drone delivery progress.',
      dataSourceNote: 'Data Source Note: Hotpot store counts from Meituan platform live store data (April 2026); consumption insights from Meituan News Center official press releases with public links. No composite ranking indices without real sources are shown.',
      section1Title: 'Hotpot Store Count by Major City',
      section1Subtitle: 'Source: Meituan Platform Active Store Data · Scope: Active Hotpot Outlets · April 2026',
      section1Footer: '* Exact counts: Chongqing 3,068, Shanghai 1,276; others are estimates based on Meituan platform data, as noted. National hotpot stores total ~67,000; total F&B stores 2.29 million.',
  ...
  'ja': {
    ...
    home: {
      ...
      heroDataSource: 'データソース：美団公式財務報告（香港取引所）· 美団ニュースセンタープレスリリース · 美団プラットフォームリアルタイムデータ',
      ...
      coreDataSubtitle: 'ソース：美団公式財務 · 美団ニュースセンター · 美団プラットフォームBI',
      viewAllData: 'すべてのデータを見る →',
      latestReportsTitle: '最新調査レポート',
      latestReportsSubtitle: 'すべてのデータは美団公式財務報告または公開プレスリリースより — 全て検証可能',
      allReports: 'すべてのレポート →',
      hotpotTitle: '火鍋店舗都市分布 TOP6',
      hotpotSubtitle: 'ソース：美団プラットフォームアクティブ店舗データ · 範囲：アクティブ飲食店 · 2026年4月',
      fullCityData: '全都市データ →',
      faqTitle: 'データよくある質問',
      faqSubtitle: 'すべてのデータは美団公式財務報告（香港取引所）、美団ニュースセンタープレスリリース、または美団プラットフォームリアルタイムデータより',
    ...
    categories: {
      ...
      dataSourceNote: 'データソース注記：消費トレンドは美団ニュースセンター公式プレスリリース（2026年1月21日）より；即時小売データは美団Q3 2025財務報告（香港取引所、2025年11月28日）より；火鍋店舗数は美団プラットフォームライブデータ（2026年4月）より。実際の出典のない総合指数は表示しません。',
      ...
      section3Title: '火鍋カテゴリー店舗データ',
      section3Subtitle: '出典：美団プラットフォームアクティブ店舗データ（T+1）· 2026年4月',
    ...
    cities: {
      ...
      breadcrumb: '都市データ',
      title: '都市次元データ 2026',
      subtitle: 'このページは美団プラットフォームの実データおよび公式プレスリリースから検証可能な都市次元データを示します。火鍋店舗分布、祝日消費インサイト、ドローン配送の進展などを含みます。',
      dataSourceNote: 'データソース注記：火鍋店舗数は美団プラットフォームライブ店舗データ（2026年4月）より；消費インサイトは美団ニュースセンター公式プレスリリースより公開リンクで検証可能。実際の出典のない総合ランキング指数は表示しません。',
      section1Title: '主要都市火鍋店舗数',
      section1Subtitle: '出典：美団プラットフォームアクティブ店舗データ · 範囲：アクティブ火鍋店舗 · 2026年4月',
      section1Footer: '* 精確値：重慶3,068店、上海1,276店；その他は美団プラットフォームデータに基づく推計値（注記済み）。全国火鍋店舗合計約6.7万店、飲食店合計229万店。',
  ...
  'es': {
    ...
    home: {
      ...
      heroDataSource: 'Fuentes de datos: Informes financieros oficiales de Meituan (HKEX) · Comunicados de prensa del Centro de Noticias Meituan · Datos de comerciantes activos de la plataforma Meituan',
      ...
      coreDataSubtitle: 'Fuentes: Finanzas oficiales Meituan · Centro de Noticias Meituan · Plataforma Meituan BI',
      ...
      hotpotTitle: 'Distribución de Restaurantes Hotpot por Ciudad TOP 6',
      hotpotSubtitle: 'Fuente: Datos de comerciantes activos en plataforma Meituan · Alcance: Establecimientos de alimentos y bebidas activos · Abril 2026',
      fullCityData: 'Datos Completos por Ciudad →',
      faqTitle: 'Preguntas Frecuentes sobre Datos',
      faqSubtitle: 'Todos los datos provienen de informes financieros oficiales de Meituan (HKEX), comunicados del Centro de Noticias Meituan, o datos de comerciantes activos de la plataforma Meituan',
    ...
    categories: {
      ...
      dataSourceNote: 'Nota de Fuente: Tendencias de consumo del comunicado del Centro de Noticias Meituan (21 ene 2026); datos de retail instantáneo del informe financiero Q3 2025 de Meituan (HKEX, 28 nov 2025); conteos de tiendas hotpot de datos en vivo de la plataforma Meituan (abril 2026). No se muestran índices compuestos sin fuentes reales.',
      ...
      section3Title: 'Datos de Tiendas de la Categoría Hotpot',
      section3Subtitle: 'Fuente: Datos de Tiendas Activas de la Plataforma Meituan (T+1) · Abril 2026',
    ...
    cities: {
      ...
      subtitle: 'Esta página presenta datos verificables de dimensión ciudad de datos reales de la plataforma Meituan y comunicados oficiales, incluyendo distribución de restaurantes hotpot, perspectivas de consumo festivo y avances en entrega por drones.',
      dataSourceNote: 'Nota de Fuente: Conteos de tiendas hotpot de datos en vivo de la plataforma Meituan (abril 2026); perspectivas de consumo de comunicados oficiales del Centro de Noticias Meituan con enlaces públicos. No se muestran índices de ranking compuestos sin fuentes reales.',
      section1Title: 'Número de Restaurantes Hotpot por Ciudad Principal',
      section1Subtitle: 'Fuente: Datos de Tiendas Activas de la Plataforma Meituan · Alcance: Restaurantes Hotpot Activos · Abril 2026',
      section1Footer: '* Conteos exactos: Chongqing 3.068, Shanghái 1.276; otros son estimaciones basadas en datos de la plataforma Meituan, como se indica. Total nacional de restaurantes hotpot ~67.000; total establecimientos F&B 2,29 millones.',
