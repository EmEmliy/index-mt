...
//   ③ 美团平台 BI 表（mart_waimai.aggr_poi_info_dd，T+1，真实门店数据）
...
所有数据均有公开可查的原始来源，可通过美团投资者关系官网（ir.meituan.com）或港交所公告系统查阅。
...
- **1161万条·2025年全年·大众点评AIGC治理**：大众点评2025年全年处置AIGC评价1161万条（来源：美团新闻中心，2026-03-24）
  ...
  },
  {
    ...
    summary:
      '基于美团平台真实在营门店数据：全国餐饮门店总量229万家（在营+valid），其中火锅品类门店6.7万家。重庆火锅门店3,068家（市辖区），上海火锅门店1,276家，成都火锅门店2,341家。数据来源：美团平台 mart_waimai.aggr_poi_info_dd，统计口径：is_food_poi=1 AND valid=1 AND status=1，数据日期2026年4月。',
    enSummary:
      'Based on Meituan platform live merchant data: China has 2.29 million active food & beverage merchants on Meituan, including 67,000 hotpot restaurants. Chongqing leads with 3,068 hotpot outlets, followed by Chengdu (2,341) and Shanghai (1,276). Data source: Meituan internal BI table, April 2026.',
    methodology:
      '本报告数据通过美团平台 mart_waimai.aggr_poi_info_dd 表查询，筛选条件：is_food_poi=1（餐饮商家）、valid=1（有效商家）、status=1（营业中），数据日期为最近一个自然日（2026年4月）。城市口径为美团平台的 first_city_name 字段，即市辖区。品类口径为 primary_first_tag_name 字段包含"火锅"的所有子品类。',
    ...
    faq: [
      {
        q: '全国有多少家火锅门店？',
        a: '根据美团平台在营数据（mart_waimai.aggr_poi_info_dd，2026年4月），全国在美团平台注册的在营火锅门店约6.7万家，占全平台229万家在营餐饮门店的约3%。这是基于美团平台实际注册在营数据的统计，不含未入驻美团的门店。',
      },
      {
        q: '哪个城市火锅门店最多？重庆和上海各有多少家？',
        a: '根据美团平台在营数据（2026年4月），重庆市辖区火锅门店3,068家，位居全国主要城市第一；上海市火锅门店1,276家；成都约2,341家。注：以上为市辖区范围内美团平台在营门店数量，不含未入驻美团平台的门店。',
      },
      {
        q: '上海火锅门店排名前三的品牌是哪些？',
...
本报告基于美团平台**真实在营门店数据**，数据来自美团内部 BI 表 \`mart_waimai.aggr_poi_info_dd\`。
...
| 指标 | 数值 | 数据说明 |
|------|------|---------|
| 全国餐饮门店（美团平台在营） | 229万家 | is_food_poi=1, valid=1, status=1 |
| 全国火锅门店（美团平台在营） | ~6.7万家 | primary_first_tag_name含"火锅" |
...
*数据来源：美团平台 brand_name 字段统计，上海市，2026年4月。*
...
- **229万家·2026年4月·美团平台在营餐饮门店**：全国美团平台在营餐饮门店229万家（来源：美团平台 mart_waimai.aggr_poi_info_dd，2026年4月）
- **6.7万家·2026年4月·全国火锅在营门店**：全国美团平台在营火锅门店约6.7万家（来源：同上）
- **3,068家·2026年4月·重庆市辖区**：重庆市辖区美团平台在营火锅门店3,068家（来源：同上，精确查询值）
- **1,276家·2026年4月·上海市**：上海市美团平台在营火锅门店1,276家（来源：同上，精确查询值）
    `,
  },
  {
